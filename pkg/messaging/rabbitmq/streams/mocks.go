...
// Source: ../pkg/messaging/rabbitmq/streams/types.go
//
// Generated by this command:
//
//	mockgen -package=streams -destination ../pkg/messaging/rabbitmq/streams/mocks.go -source ../pkg/messaging/rabbitmq/streams/types.go
//
...
func (m *MockConnection) Connect(ctx context.Context) (*stream.Environment, error) {
	m.ctrl.T.Helper()
...
func (m *MockListener) OnMessage(ctx context.Context, message *amqp.Message) error {
	m.ctrl.T.Helper()
...
func (m *MockProducer) Produce(ctx context.Context, message *amqp.AMQP10) error {
	m.ctrl.T.Helper()
