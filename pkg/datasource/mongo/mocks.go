...
// Source: ../pkg/datasource/mongo/types.go
//
// Generated by this command:
//
//	mockgen -package=mongo -destination ../pkg/datasource/mongo/mocks.go -source ../pkg/datasource/mongo/types.go
//
...
func (m *MockConnection) Connect(ctx context.Context) (*mongo.Client, error) {
	m.ctrl.T.Helper()
...
func (m *MockTransactionHandler) HandleTransaction(ctx context.Context, fn TransactionHandlerFn) (any, error) {
	m.ctrl.T.Helper()
